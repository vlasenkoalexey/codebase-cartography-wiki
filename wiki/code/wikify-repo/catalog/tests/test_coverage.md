...
- `test_docstring_extracted_into_catalog()` — [`L137`](../../../../../raw/code/wikify-repo/tests/test_coverage.py#L137) — The author's docstring (parsed from scip `documentation`) reaches the page —
- `test_docstring_strips_signature_fence()` — [`L247`](../../../../../raw/code/wikify-repo/tests/test_coverage.py#L247)
- `test_documentable_excludes_external()` — [`L47`](../../../../../raw/code/wikify-repo/tests/test_coverage.py#L47)
...
- `test_member_detail_promotes_documented_and_folds_plumbing()` — [`L161`](../../../../../raw/code/wikify-repo/tests/test_coverage.py#L161) — A: public/documented members get full detail (name(params) — line — doc);
- `test_report_classifies_covered_vs_catalog(tmp_path)` — [`L60`](../../../../../raw/code/wikify-repo/tests/test_coverage.py#L60)
- `test_used_by_excludes_tests_and_ranks_by_importance()` — [`L113`](../../../../../raw/code/wikify-repo/tests/test_coverage.py#L113)
