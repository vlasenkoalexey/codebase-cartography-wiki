...
- `test_rule1_dead_anchor_repaired_to_packet_link(tmp_path)` — [`L50`](../../../../../raw/code/wikify-repo/tests/test_fix.py#L50)
...
- `test_rule3_out_of_subgraph_delinked(tmp_path)` — [`L61`](../../../../../raw/code/wikify-repo/tests/test_fix.py#L61)
