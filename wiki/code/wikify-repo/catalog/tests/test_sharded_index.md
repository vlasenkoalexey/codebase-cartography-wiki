...
- `test_merge_keeps_repo_relative_spillover_and_prefers_complete(tmp_path: Path)` — [`L57`](../../../../../raw/code/wikify-repo/tests/test_sharded_index.py#L57) — documented in [wikify-scip_index](../../concepts/wikify-scip_index.md)
- `test_merge_repairs_target_relative_paths(tmp_path: Path)` — [`L44`](../../../../../raw/code/wikify-repo/tests/test_sharded_index.py#L44) — documented in [wikify-scip_index](../../concepts/wikify-scip_index.md)
