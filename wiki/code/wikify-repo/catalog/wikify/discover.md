...
## Classes
### `Community`
- def: [`wikify/discover.py:122`](../../../../../raw/code/wikify-repo/wikify/discover.py#L122) — documented in [wikify-discover](../../concepts/wikify-discover.md)
- signature: `class Community:`
- members:
  - `interactions(self)` — [`L132`](../../../../../raw/code/wikify-repo/wikify/discover.py#L132) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `boundary_edges` — [`L126`](../../../../../raw/code/wikify-repo/wikify/discover.py#L126) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `internal_edges` — [`L125`](../../../../../raw/code/wikify-repo/wikify/discover.py#L125) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `label` — [`L123`](../../../../../raw/code/wikify-repo/wikify/discover.py#L123) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `members` — [`L124`](../../../../../raw/code/wikify-repo/wikify/discover.py#L124) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `modules` — [`L128`](../../../../../raw/code/wikify-repo/wikify/discover.py#L128) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `neighbors` — [`L129`](../../../../../raw/code/wikify-repo/wikify/discover.py#L129) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `top_members` — [`L127`](../../../../../raw/code/wikify-repo/wikify/discover.py#L127) — documented in [wikify-discover](../../concepts/wikify-discover.md)
...
- used by: [`discover_concepts`](discover.md#discover_concepts), [`_derive_agenda`](cli.md#_derive_agenda)  (3 test-only)

## Functions
- `_concept_slug(module: str)` — [`L46`](../../../../../raw/code/wikify-repo/wikify/discover.py#L46) — Readable concept slug from a module path (drop top package + extension).
...
- `_undirected_adj(graph: SymbolGraph, allowed: set[str] | None = None)` — [`L136`](../../../../../raw/code/wikify-repo/wikify/discover.py#L136) — documented in [wikify-discover](../../concepts/wikify-discover.md)
...
- `module_importance(graph: SymbolGraph)` — [`L58`](../../../../../raw/code/wikify-repo/wikify/discover.py#L58) — Per-module aggregate stats: fan-in (centrality), symbol/class counts, seeds. — documented in [wikify-discover](../../concepts/wikify-discover.md)
