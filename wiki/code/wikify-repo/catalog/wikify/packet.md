...
## Functions
- `_edge_name(graph: SymbolGraph, src: str, dst: str)` — [`L131`](../../../../../raw/code/wikify-repo/wikify/packet.py#L131) — Display name for an edge ``src→dst``, tagged ``(virtual)`` if it is a
...
- `_short(moniker: str, graph: SymbolGraph)` — [`L127`](../../../../../raw/code/wikify-repo/wikify/packet.py#L127)
- `auto_seeds(graph: SymbolGraph, n: int = 8)` — [`L68`](../../../../../raw/code/wikify-repo/wikify/packet.py#L68) — Discovery fallback: the n highest-importance callable symbols.
- `build_packet(graph: SymbolGraph, repo_root: str | Path, slug: str, ref: str, concept: Concept, test_globs: list[str], date: str, seed_monikers: list[str] | None = None, focus: str = "", vocab: list[str] | None = None)` — [`L146`](../../../../../raw/code/wikify-repo/wikify/packet.py#L146) — Render the packet markdown and return (text, subgraph_monikers). — documented in [wikify-cli](../../concepts/wikify-cli.md)
...
- `read_subgraph(cache_dir: str | Path, slug: str, concept_slug: str)` — [`L274`](../../../../../raw/code/wikify-repo/wikify/packet.py#L274) — documented in [wikify-lint](../../concepts/wikify-lint.md)
...
- `write_packet(cache_dir: str | Path, slug: str, concept_slug: str, text: str, subgraph: list[str])` — [`L261`](../../../../../raw/code/wikify-repo/wikify/packet.py#L261)
...
- `_TEMPLATE_RULES` — [`L281`](../../../../../raw/code/wikify-repo/wikify/packet.py#L281)
