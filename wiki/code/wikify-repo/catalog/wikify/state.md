...
- `has_page(state: dict, concept: str)` — [`L85`](../../../../../raw/code/wikify-repo/wikify/state.py#L85) — Whether a page has been recorded for ``concept``. — documented in [wikify-diff](../../concepts/wikify-diff.md)
...
- `page_cited(state: dict, concept: str)` — [`L80`](../../../../../raw/code/wikify-repo/wikify/state.py#L80) — Return the cited monikers for ``concept`` (empty list if no such page). — documented in [wikify-diff](../../concepts/wikify-diff.md)
...
- `set_ref(state: dict, ref: str)` — [`L67`](../../../../../raw/code/wikify-repo/wikify/state.py#L67) — Record the pinned commit the state corresponds to. — documented in [wikify-state](../../concepts/wikify-state.md)
...
- `state_path(cache_dir: str | Path, slug: str)` — [`L22`](../../../../../raw/code/wikify-repo/wikify/state.py#L22) — Return the on-disk path of the state file: ``<cache_dir>/state/<slug>.json``.
