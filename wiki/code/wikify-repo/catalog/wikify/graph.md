...
## Classes
### `Symbol`
- def: [`wikify/graph.py:18`](../../../../../raw/code/wikify-repo/wikify/graph.py#L18) — documented in [wikify-discover](../../concepts/wikify-discover.md)
...
- members:
  ...
  - `docstring(self)` — [`L38`](../../../../../raw/code/wikify-repo/wikify/graph.py#L38) — Author-written prose from ``documentation``, signature code-fence stripped.
  - `is_callable(self)` — [`L34`](../../../../../raw/code/wikify-repo/wikify/graph.py#L34)
  - `def_line` — [`L26`](../../../../../raw/code/wikify-repo/wikify/graph.py#L26) — documented in [wikify-diff](../../concepts/wikify-diff.md)
  - `def_path` — [`L25`](../../../../../raw/code/wikify-repo/wikify/graph.py#L25) — documented in [wikify-diff](../../concepts/wikify-diff.md)
  - `documentation` — [`L29`](../../../../../raw/code/wikify-repo/wikify/graph.py#L29) — documented in [wikify-scip_index](../../concepts/wikify-scip_index.md)
  - `enclosing` — [`L27`](../../../../../raw/code/wikify-repo/wikify/graph.py#L27) — documented in [wikify-diff](../../concepts/wikify-diff.md)
  - `kind` — [`L22`](../../../../../raw/code/wikify-repo/wikify/graph.py#L22) — documented in [wikify-scip_index](../../concepts/wikify-scip_index.md)
  - `moniker` — [`L21`](../../../../../raw/code/wikify-repo/wikify/graph.py#L21) — documented in [wikify-scip_index](../../concepts/wikify-scip_index.md)
  - `name` — [`L24`](../../../../../raw/code/wikify-repo/wikify/graph.py#L24) — documented in [wikify-graph](../../concepts/wikify-graph.md)
  - `relationships` — [`L30`](../../../../../raw/code/wikify-repo/wikify/graph.py#L30) — documented in [wikify-scip_index](../../concepts/wikify-scip_index.md)
  - `signature` — [`L28`](../../../../../raw/code/wikify-repo/wikify/graph.py#L28) — documented in [wikify-diff](../../concepts/wikify-diff.md)
  - `suffix` — [`L23`](../../../../../raw/code/wikify-repo/wikify/graph.py#L23) — documented in [wikify-discover](../../concepts/wikify-discover.md)
- uses (calls/refs, reference-scoped): [`_CALLABLE_KINDS`](graph.md#_CALLABLE_KINDS), [`_clean_doc`](graph.md#_clean_doc)
- used by: [`build_packet`](packet.md#build_packet), [`build_graph`](scip_index.md#build_graph), [`render_catalog`](coverage.md#render_catalog), [`symbols`](graph.md#SymbolGraph.symbols), [`add_symbol`](graph.md#SymbolGraph.add_symbol), [`detect_communities`](discover.md#detect_communities), [`_process_document`](scip_index.md#_process_document), [`compute_report`](coverage.md#compute_report), [`collect_tests`](evidence.md#collect_tests), [`_synth_symbol`](scip_index.md#_synth_symbol), [`_link_targets`](coverage.md#render_catalog._link_targets), [`documentable_symbols`](coverage.md#documentable_symbols), [`devirtualize`](graph.md#devirtualize), [`covered_monikers`](coverage.md#covered_monikers), [`module_importance`](discover.md#module_importance), [`class_symbols`](coverage.md#class_symbols), [`read_snippet`](source.md#read_snippet), [`_library_nodes`](discover.md#_library_nodes), [`_rel_names`](coverage.md#_rel_names), [`auto_seeds`](packet.md#auto_seeds), [`_short`](packet.md#_short), [`_excluded_fraction`](discover.md#_excluded_fraction), [`find`](graph.md#SymbolGraph.find), [`body_hash`](source.md#body_hash), [`body_span`](source.md#body_span), [`_clean_sig`](coverage.md#_clean_sig), [`_params`](coverage.md#_params), [`by_module`](coverage.md#by_module)  (17 test-only)
...
- members:
  ...
  - `callees(self, moniker: str)` — [`L129`](../../../../../raw/code/wikify-repo/wikify/graph.py#L129) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `callers(self, moniker: str)` — [`L132`](../../../../../raw/code/wikify-repo/wikify/graph.py#L132) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `find(self, name: str)` — [`L140`](../../../../../raw/code/wikify-repo/wikify/graph.py#L140) — Monikers whose terminal descriptor name == ``name`` (test/debug helper). — documented in [wikify-graph](../../concepts/wikify-graph.md)
  ...
  - `ref_count` — [`L100`](../../../../../raw/code/wikify-repo/wikify/graph.py#L100) — documented in [wikify-discover](../../concepts/wikify-discover.md)
  - `refs` — [`L101`](../../../../../raw/code/wikify-repo/wikify/graph.py#L101) — documented in [wikify-scip_index](../../concepts/wikify-scip_index.md)
  - `symbols` — [`L97`](../../../../../raw/code/wikify-repo/wikify/graph.py#L97) — documented in [wikify-diff](../../concepts/wikify-diff.md)
  - `virtual_edges` — [`L104`](../../../../../raw/code/wikify-repo/wikify/graph.py#L104) — documented in [wikify-scip_index](../../concepts/wikify-scip_index.md)
...
- used by: [`build_packet`](packet.md#build_packet), [`build_graph`](scip_index.md#build_graph), [`render_catalog`](coverage.md#render_catalog), [`detect_communities`](discover.md#detect_communities), [`_process_document`](scip_index.md#_process_document), [`compute_report`](coverage.md#compute_report), [`collect_tests`](evidence.md#collect_tests), [`lint_page`](lint.md#lint_page), [`compute_plan`](diff.md#compute_plan), [`discover_concepts`](discover.md#discover_concepts), [`fix_page`](fix.md#fix_page), [`emit_catalogs`](coverage.md#emit_catalogs), [`_link_targets`](coverage.md#render_catalog._link_targets), [`documentable_symbols`](coverage.md#documentable_symbols), [`gather_subgraph`](packet.md#gather_subgraph), [`lint_doc_concepts`](lint.md#lint_doc_concepts), [`devirtualize`](graph.md#devirtualize), [`covered_monikers`](coverage.md#covered_monikers), [`lint_silo`](lint.md#lint_silo), [`module_importance`](discover.md#module_importance), [`class_symbols`](coverage.md#class_symbols), [`fix_silo`](fix.md#fix_silo), [`current_hashes`](diff.md#current_hashes), [`_library_nodes`](discover.md#_library_nodes), [`auto_seeds`](packet.md#auto_seeds), [`index_repo`](scip_index.md#index_repo), [`resolve_seeds`](packet.md#resolve_seeds), [`_short`](packet.md#_short), [`_excluded_fraction`](discover.md#_excluded_fraction), [`pareto_communities`](discover.md#pareto_communities), [`_edge_name`](packet.md#_edge_name), [`_undirected_adj`](discover.md#_undirected_adj), [`class_connections`](coverage.md#class_connections), [`symbol_anchor_map`](coverage.md#symbol_anchor_map), [`label_propagation`](discover.md#label_propagation), [`relevance`](packet.md#gather_subgraph.relevance)  (22 test-only)
...
- `devirtualize(graph: SymbolGraph)` — [`L154`](../../../../../raw/code/wikify-repo/wikify/graph.py#L154) — Class Hierarchy Analysis: cross the dynamic-dispatch seam the reference — documented in [wikify-graph](../../concepts/wikify-graph.md)
